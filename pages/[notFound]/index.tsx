  ...
  return (
    <div className="mt-10 sm:-mt-6 md:mt-0 md:max-w-4xl md:grid-cols-3 md:m-auto md:mt-8 p-6 bg-gray-900 shadow overflow-hidden sm:rounded-md m-auto bg-opacity-60">
      ...
      <div className="md:grid md:grid-cols-2">
        ...
        <div className="">
          <h3 className="text-2xl font-medium leading-6 text-white pb-8 text-center mx-4 md:mt-24">Apparently you have reached an ended concert. Let&apos;s look for another one...</h3>
